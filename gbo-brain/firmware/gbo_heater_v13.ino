/* =====================================================================
   ...
   ---------------------------------------------------------------------
   v13, что изменено против v3 (1-3 из v4, 4 из v5, 6 из v6, 7 из v7, 8-9 из v8, 10 из v9, 11-12 из v11, 13 из v12):
...
void handleCal() {
  ...
  if (!vbatValid)              { server.send(200, "text/plain", "канал в насыщении"); return; }
  if (vbatMv > ADC_LIN_MAX_MV) { server.send(200, "text/plain", "вне линейной зоны АЦП"); return; }
  if (vbatMv < 200)            { server.send(200, "text/plain", "слишком низкое напряжение"); return; }
  ...
  if (hasV) {
    ...
    if (v < 5.0 || v > 20.0) { server.send(200, "text/plain", "вне диапазона 5..20 В"); return; }
    calA = v / p;
    calB = 0;
    calLoP = calHiP = 0;
