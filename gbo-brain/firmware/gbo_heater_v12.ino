...
/* Аппаратный ШИМ. 2 Гц, которые были раньше, при 20 А давали пульсацию
   ...
   ВАЖНО: высокая частота требует конденсатора у самого транзистора, см.
   примечание в README. Без него индуктивность проводки даёт выброс при
   каждом выключении, и на килогерце это уже не единичные события. */
