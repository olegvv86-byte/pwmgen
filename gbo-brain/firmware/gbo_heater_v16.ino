/* =====================================================================
   ...
   ---------------------------------------------------------------------
   v16, что изменено против v3 (1-3 из v4, 4 из v5, 6 из v6, 7 из v7, 8-9 из v8, 10 из v9, 11-12 из v11, 13 из v12, 14 из v13, 15 из v14, 16 из v15):
...
void checkProtections() {
  ...
  if (tHot >= TEN_MAX) { duty = 0; gateOff(); raiseFault(5); return; }
